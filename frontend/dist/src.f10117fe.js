...
function renderTurtlePanel(turtle) {
  var _this = this;

  var generateListener = function generateListener(name) {
    return function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4
              /*yield*/
              , fetch("http://51.146.6.229:6969/api/turtles/" + turtle + "?exec=" + name, {
                method: "GET"
              })];
  ...
  return lit_html_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject([" <div class=\"turtle-container\">\n    <button @click=", ">Make ", " dance!</button>\n  </div>"], [" <div class=\"turtle-container\">\n    <button @click=", ">Make ", " dance!</button>\n  </div>"])), generateListener("dance"), turtle);
}

fetch("http://51.146.6.229:6969/api/turtles", {
  method: "GET"
}).then(function (r) {
  return r.json();
}).then(function (turtles) {
  lit_html_1.render(turtles.map(function (turtle) {
    return renderTurtlePanel(turtle);
  }), document.body);
});
var templateObject_1;
},{"lit-html":"node_modules/lit-html/lit-html.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "2997" + '/');
